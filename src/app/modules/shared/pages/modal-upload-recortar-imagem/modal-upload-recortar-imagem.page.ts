...
@Component({
  selector: 'app-modal-upload-recortar-imagem',
  templateUrl: './modal-upload-recortar-imagem.page.html',
  styleUrls: ['./modal-upload-recortar-imagem.page.scss'],
})
export class ModalUploadRecortarImagemPage implements OnInit {
